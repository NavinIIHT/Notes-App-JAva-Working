...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<NotesExceptionResponse> NotesHandler(InvalidNoteDataException ex){
		NotesExceptionResponse resp = 
				new NotesExceptionResponse(ex.getMessage(),System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value());
	...
	public ResponseEntity<NotesExceptionResponse> NotesHandler(NoteIdNotFoundException ex){
		NotesExceptionResponse resp = 
				new NotesExceptionResponse(ex.getMessage(),System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value());
